...
export const Card: FC<CardProps> = ({
  ...
  return (
    <div
      ...
      className={`overflow-hidden bg-transparent relative border border-slate-300  rounded-md  ${
        isDragging ? 'border-2 border-slate-400 ' : 'border'
    ...
    >
      ...
      <div
        className={` hidden group-hover:block p-4 bg-slate-600 absolute top-0 left-0 bottom-0 right-0`}
      >
        <input
          type="checkbox"
          checked={isChecked}
